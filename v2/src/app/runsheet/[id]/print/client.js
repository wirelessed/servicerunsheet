...
export default function RunsheetPrintPage() {
    ...
    useEffect(() => {
        ...
        const unsubRunsheet = onSnapshot(doc(db, 'runsheets', id), (docSnap) => {
            ...
            setLoading(false); // Found or not found, we know the definitive status now.
        });
    ...
    return (
        <div className="print-container bg-white text-[#1c1c1e] min-h-screen print:min-h-0 font-sans">
            ...
            <div className="no-print p-4 bg-gray-100 border-b border-gray-200 flex justify-end items-center sticky top-0 z-50">
                <button
                    onClick={handlePrint}
